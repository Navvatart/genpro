    ...
    <div class="row">
        <div class="col-md-6 ">
            ...
            <div class="col-12 mt-2  pull-right">
                ...
                <button onclick="serversCreate()" class="btn btn-success  mt-1 pull-right">SAVE</i></button>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="mt-2 mb-2 pull-right">
                <!-- <button onclick="serversUpdate()" class="btn btn-warning  mt-1">UPDATE</i></button> -->
