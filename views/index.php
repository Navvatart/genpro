<script src="config/mode/method.js"></script>
<script src="dist/js/index.js"></script>
<script src="dist/js/generate.js"></script>
<script src="config/mode/trojan.js"></script>
<script src="config/mode/vmess.js"></script>
<?php 
// var_dump($modelsbugs)
?>
<div class="container">
        ...
        <div class="col-md-6 p-2" style="border-right: 1px solid #333; border-radiuss:1%; margin-right:0px;">
            ...
            <div class="row">
                ...
                foreach ($modelservers as $file) { 
                    ...
                    if (is_file($filePath)) {
                        $list =  explode("-", str_replace('.json', '', $file));
                        if ($listg != $list[0]) { ?>
                        <option value="<?=  $list[0]?>"><?=  $list[0]?></option>
                        <option value="<?= str_replace('.json', '', $file) ?>"><?= '&nbsp;&nbsp;&nbsp;'. $list[1] ?>
                        </option>
                        <?php } else { ?>
                        <option value="<?= str_replace('.json', '', $file) ?>"><?= '&nbsp;&nbsp;&nbsp;'. $list[1] ?>
                        </option>
            ...
            <small class="pull-right">Hapus yang tidak perlu!...</small>
                    ...
                    <?php } 
                           $bugG = '';
                            foreach ($modelsbugs as $file) { 
                                ...
                                if (is_file($filePath)) {
                                 $cek = explode("-", str_replace('.json', '', $file));
